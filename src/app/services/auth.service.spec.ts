...
//     MockInstance(Auth, 'authState', of({uid: 'test-uid'} as any));
//
//     let fixture = MockRender(serviceType);
//     let service = fixture.point.componentInstance;
//
...
//     spyOn(GoogleAuthProvider, 'GoogleAuthProvider');
//     let spySignInWithPopup = MockInstance(Auth, 'signInWithPopup', createSpy()
...
//     let spySignOut = MockInstance(Auth, 'signOut', createSpy());
...
//     let spySignInWithEmailAndPassword = MockInstance(Auth, 'signInWithEmailAndPassword',
...
//     let spyCreateUserWithEmailAndPassword = MockInstance(Auth, 'createUserWithEmailAndPassword', createSpy()
//       .and.returnValue({user: {}}));
//
//     let fixture = MockRender(serviceType);
//     let service = fixture.point.componentInstance;
...
//     let spySendPasswordResetEmail = MockInstance(Auth, 'sendPasswordResetEmail', createSpy());
//
//     let fixture = MockRender(serviceType);
//     let service = fixture.point.componentInstance;
//
